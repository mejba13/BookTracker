<x-layout>
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            <nav aria-label="Breadcrumb">
                <ol role="list" class="mx-auto flex max-w-4xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    <li>
                    ...
                    <li>
                        <div class="flex items-center">
                            <a href="#" class="mr-2 text-sm font-medium text-gray-900">{{ $book->title }}</a>
                            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
                                <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                            </svg>
                        </div>
            ...
            <div class="lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 pt-20 lg:px-8">
                ...
                <div class="mt-20 lg:row-span-3 lg:mt-0">
                    ...
                    <form class="mt-10">
                        <button type="submit" class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Buy Now</button>
                    </form>
                </div>
            </div>

            <!-- Product info -->
                <div class=" lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 ">
